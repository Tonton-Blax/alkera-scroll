<script>
    ...
    onMount(async() => {
        ...
        .fromTo('#le-point', { scale: 1 }, {scale:160, duration:baseDuration * 1.5, ease:'circ.in'},'<')
        .fromTo('#le-cercle-1',{ scale:0 }, {scale:60, rotate: 720, duration:baseDuration * 1.5, ease:'circ.in'},'<')
...
<section id="section-intro" class="lol">
